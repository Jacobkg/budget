class Transfer < ActiveRecord::Base
  ...
  def self.execute(description, amount, source_account, destination_account)
    create_transfer(description, amount, source_account, destination_account)
  ...
  private
    ...
    def self.create_transfer(description, amount, source_account, destination_account)
